...
namespace LicenseReleaseService.TimerExecution
{
    ...
    {
        /// <summary>
        /// Gets or sets the unique identifier for the error event
        /// </summary>
        public Guid ErrorId { get; set; }

        /// <summary>
        /// Gets or sets the execution ID associated with the error
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the consecutive error count
        /// </summary>
        public int ConsecutiveErrors { get; set; }

        /// <summary>
        /// Gets or sets the timer state when error occurred
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the handling result message
        /// </summary>
        ...
        public TimerErrorEventArgs()
        {
            ...
            Category = TimerErrorCategory.Unknown;
            RecommendedAction = TimerRecoveryAction.LogAndContinue;
        }

        /// <summary>
        /// Initializes a new instance of the TimerErrorEventArgs class with parameters
        /// </summary>
        /// <param name="exception">The exception that occurred</param>
        /// <param name="executionId">The execution ID</param>
        /// <param name="timerState">The timer state</param>
        /// <param name="consecutiveErrors">The consecutive error count</param>
        public TimerErrorEventArgs(Exception exception, Guid? executionId, TimerState timerState, int consecutiveErrors)
            : this()
        {
        ...
        public bool ShouldStopTimer =>
            ...
            (Category == TimerErrorCategory.Resource && ConsecutiveErrors > 5);
        ...
        {
            return $"TimerErrorEventArgs[ErrorId={ErrorId}, " +
                   $"Severity={Severity}, Category={Category}, " +
                   $"Action={RecommendedAction}, Consecutive={ConsecutiveErrors}, " +
                   $"Handled={WasHandled}, ExecutionId={ExecutionId}, " +
